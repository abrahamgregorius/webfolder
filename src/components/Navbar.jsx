    ...
    return(
        ...
        <div className="navbar select-none flex justify-between items-center relative font-semibold">
                ...
                <div className="nav-right max-[420px]:hidden flex gap-3">
                    ...
                    <NavLink className={"text-sm cursor-pointer hover:underline transition"} to="/experiences">experiences</NavLink>
                    <NavLink className={"text-sm cursor-pointer hover:underline transition"} to="/achievements">achievements</NavLink>
                </div>
            </div>
            <div className={`nav-toggle-menu text-lg h-[18vh] text-right font-normal border-b gap-1 mb-2 mt-2 w-full flex px-4 pb-3 justify-center flex-col min-[420px]:hidden ${isNavbarClicked ? "flex" : "hidden"}`}>
                ...
                <NavLink className={"hover:text-slate-400 transition"} to="/experiences">experiences</NavLink>
